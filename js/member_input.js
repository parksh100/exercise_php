...
document.addEventListener("DOMContentLoaded", function () {
    ...
    xhr.onload = () => {
      if (xhr.status == 200) {
        ...
        if (data.result == "success") {
          ...
          document.input_form.zipcode.focus();
        } else if (data.result == "fail") {
  ...
  btn_zipcode.addEventListener("click", function () {
    new daum.Postcode({
